...
<section
    ...
    class="bg-brand-green-50 py-16 sm:py-24"
>
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            <template x-for="(stat, index) in stats" :key="index">
                <div class="p-4">
                    <span class="text-5xl font-extrabold text-brand-green-700" x-text="Math.round(stat.current) + stat.suffix"></span>
                    <p class="mt-2 text-lg text-gray-600" x-text="stat.label"></p>
                </div>
            </template>
        </div>
    </div>
